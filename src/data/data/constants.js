export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1ezBSOMLRnKU7uiNaFphKNAqC_ZmkKaHP/view?usp=sharing",
  ...
  facebook: "https://m.facebook.com/chandrakant.tripathi.1441/",
};
...
export const skills = [
   ...
   },
  {
    title: "Others",
    skills: [
      { name: "C++", image: require("./image/C++.png") },
      { name: "C", image: require("./image/C.png") },
      { name: "Java", image: require("./image/java.png") },
      ...
      {
        name: "Chatgpt",
        image: require("./image/Chatgpt.png"),
      },
      {
        name: "Blackbox AI",
        image: require("./image/BlackboxAI.jpeg"),
      },
      {
        name: "Excel",
        image: require("./image/excel.jpeg"),
      },
      {
        name: "Powerpoint",
        image: require("./image/powerpoint.jpeg"),
      },
      // {
      //   name: "Adobe XD",
      //   image:
...
export const education = [
  ...
  {
    id: 1,
    img: require("./image/shivajim.png"),
    school: "Shri Shivaji Science College ,Nagpur",
    date: "Apr 2022 - Apr 2023",
    grade: "75.33%",
    desc: "I completed my class 12 high school education at Shri Shivaji Science College, Nagpur, where I studied Science in PCMB group.",
    degree: "(XII),Maharastra State Board ",
  },
  {
    id: 2,
    img: require("./image/anthony.png"),
    school: "St Anthony's High School, Nagpur",
    date: "Apr 2020 - Apr 2021",
    grade: "95.4%",
    desc: "I completed my class 10 education at St Anthony's High School, Nagpur.",
    degree: "(X),Maharastra State Board ",
  },
];
...
export const projects= [
  ...
  },
  {
  ...
  
    {
      ...
      description:
        "It features message analysis to identify specific users, Gemini API integration for contextual response generation, and a continuous workflow for seamless interaction. Built with Python for clipboard integration and browser automation, this system is ideal for automating customer support or creating interactive bots",
      image:require("./image/chat.webp"),
        
        tags: ["Python", "Automation", "Gemini API", "Chatbot", "Message Analysis", "Clipboard Integration", "Browser Automation"],
      category: "python app",
   ...
   
    {
      ...
      date: "Dec 2024 - Dec 2024",
      description:
        "It features voice recognition to detect commands, Gemini API integration for intelligent and context-aware responses, and multimedia interaction for seamless task execution. Built with Python, this virtual assistant supports hands-free browsing, music playback, and dynamic text-to-speech conversion, making it perfect for automating daily tasks or creating interactive virtual assistant experiences.",
        image:require("./image/jarvis.webp"),
        tags: ["Python", "Voice Recognition", "Virtual Assistant", "Gemini API", "Text-to-Speech", "NewsAPI", "Automation", "Multimedia"],
      category: "python app",
      github: "https://github.com/192005chandrakant/Voice-Recognition-and-Virtual-Assistant",
      webapp: "https://github.com/192005chandrakant/Voice-Recognition-and-Virtual-Assistant",
    },
    {
      id: 6,
      title: "Tic-tak-Toe",
    ...
    },
    {
      ...
      category: "web app",
      github: "https://github.com/192005chandrakant/rock-paper-scissor-game",
    ...
    },
    {
      ...
      tags: ["HTML"," CSS","cdn js"],
      category: "web app",
      github: "https://github.com/192005chandrakant/AMAZON-UI-CLONE",
      webapp: "https://192005chandrakant.github.io/AMAZON-UI-CLONE/",
      // member: [
      // //   {
      // //     name: "",
      // //     img: "",
